...
<div className="line_chart" > 
    <h2>customers based on gender</h2>
<LineChart width={900} height={500} data={line_chart}
  ...
  <Line name="male customers" type="monotone" dataKey="male" stroke="#8884d8" />
  <Line name="female customers" type="monotone" dataKey="female" stroke="#82ca9d" />
</LineChart>
</div>
